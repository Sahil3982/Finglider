...
mainApp.controller('menuController', ['$scope', '$timeout', function ($scope, $timeout) {
    ...
    $scope.BillSummary = { "ItemTotal": 0, "GrandTotal": 0, "RestaurantCharges": 0, "DeliveryFee": 0, "Discount": 0, "PolicyDescription": "", "DeliveryNotes": "", "IsShow": false };
    $scope.searchText = "";
    $scope.filterType = 0;
    $scope.alertMessage = "";
    ...
    $scope.GenerateBill = function () {
        if ($scope.selectedItems.length > 0) {
            ...
            $scope.BillSummary.RestaurantCharges = containerTotal;
            $scope.BillSummary.DeliveryFee = $scope.restaurantInfo.DeliverCharge;
            $scope.BillSummary.Discount = 0;
            $scope.BillSummary.GrandTotal = total + (total * $scope.restaurantInfo.Tax) + $scope.restaurantInfo.DeliverCharge + containerTotal;
    ...
    $scope.PlaceOrderInWhatsapp = function (grandTotal) {
        ...
        window.open("https://wa.me/" + whatsappNumber + "?text=" + encodeURIComponent(itemsSelected));
        //window.open("https://api.whatsapp.com/send?phone=+whatsappNumber&text=urlencodedtext")
        //window.open("https://api.whatsapp.com/send?phone=" + whatsappNumber + "&text=" + encodeURIComponent(itemsSelected));
        // const link = "whatsapp://send?phone=" + whatsappNumber + " &text=" + encodeURIComponent(itemsSelected);
    ...
    $scope.CalculateTotalPay = function (price) {
        return BillSummary.ItemTotal + (price * RestaurantInfo.Tax) + RestaurantInfo.DeliverCharge;
