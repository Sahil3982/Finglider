...
const CartBox = ({
  ...
  const removeItem = (menuId) => {
    ...
    setCart(updatedCart);
    {
      removedItem.OfferDescription
        ? updateTotalPrice(
            -(removedItem.Price * (1 - removedItem.OfferHihglight))
          )
  ...
  const handleFormSubmit = () => {
    ...
    if (!name || !phoneNumber || !email || !address) {
      ...
      enqueueSnackbar(`Thank you ${name} for your Order !`, {
        variant: "success",
      });
      setForm({
        name: "",
  ...
  const handlePostClick = async () => {
    try {
      const response = await axios.post("http://localhost:3008/api/cart", {
        name: form.name,
  ...
  return (
    <SnackbarProvider>
      {cartVisible && (
        ...
        >
          <div
            className="modal-dialog  mt-5  mx-auto shadow-lg border border-4 border-black"
            role="document"
            style={{ zIndex: 1200, top: "-35px" }}
          >
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-md-12 col-lg-12 col-12 order-md-last">
                      ...
                      {size === 0 && (
                        <div>
                          <h6 className="text-danger mb-0 text-center">
                            {translation.cartisempty}
                          </h6>
                          ...
                          {cart.map((item, index) => (
                            ...
                            >
                              <div className="col-5 col-md-6 col-lg-3">
                                ...
                                <small className="text-body-secondary number font-weight-bold fs-5 ">
                                  {item.Heighlightdescription}
                                </small>
                              </div>
                              ...
                              <span className="text-body-secondary number font-weight-bold fs-5">
                                ₹{item.Price * (1 - item.OfferHihglight)}
                              </span>
                            </li>
                          ))}
                        </ul>
                            ...
                            <form>
                              ...
                              <div className="mb-3">
                                ...
                                <input
                                  type="tel"
                                  className={`form-control ${
                                    !phoneNumber && !showOtp && `is-invalid`
                                  }`}
                                  id="phoneNumber"
                                ...
                                {!phoneNumber && !showOtp && (
                                  <div className="invalid-feedback mb-3">
                                    <p
                                      className="text-bold text-danger mb-0"
                                      style={{ fontSize: "12px" }}
                                    >
                                      Please Verify Your PhoneNumber!
                                    </p>
      ...
      <div>
        {!show && (
          <div className="container">
            <div
              className="modal  modal-sheet position-fixed d-block bg-body-secondary  row "
              tabindex="-1"
              role="dialog"
              id="modalSheet"
              style={{ zIndex: "1200" }}
            >
              <div className="modal-dialog" role="document">
                <div
                  className="modal-content rounded-4 shadow col-12 "
                  style={{ height: "660px", width: "540px", overflowY: "auto" }}
                >
