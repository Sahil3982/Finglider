...
function SectionItem(props) {
  ...
  return (
    <div class="cat-item px-3 py-3">
        <a  class="bg-white rounded d-block p-1 text-center text-black-75" style={{minHeight:100,minWidth:80,fontSize:'15px' }} href=''> 
        <p class="m-2 medium" >{sectionItem.SectionName}</p></a>
