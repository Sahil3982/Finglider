    ...
    <div
        ...
        <div className="list-card-image">
         ...
         {menuItem.Type.length > 0 &&(
            <div className={`${menuItem.Type === 'Veg' ? 'text-success veg':
              menuItem.Type === 'Egg' ? 'text-warning veg':'text-danger non_veg'
            }`}> .
            </div>
         )}
          </div>
           ...
           {isOffer && (<div className='offer-badge'> {isOffer}</div>)} 
            ...
            <img loading="lazy" alt="#"  src={menuItem.ImageUrl} className="img-fluid item-img w-100" />
        ...
        <div className="p-3 position-relative">
            <div className="list-card-body">
                ...
                <h6 className="mb-1"><span className="text-black text-wrap">{menuItem.Item}
                    </span>
                </h6>
            ...
            <div>
               ...
               {showCartButton && (<div className="container col-lg-12 col-md-6"> <span  className="float-left "
                     ng-if="">
                       ...
                       onClick={() => {props.handleClick(menuItem);
                        ...
                        data-target="#extras"
                        disabled={isAvailable === 0}>ADD </button>
                </span></div>
                )}
                ...
                <div ng-if="(menuItem.QuantitySection==null||menuItem.QuantitySection.length==0)&&SelectedQuantity(menuItem) > 0">
                    ...
                    <span 
                    ng-if="menuItem.QuantitySecton.length>0 && SelectedQuantity(menuItem)>0">
                    ...
                    <span 
                    ng-if="(menuItem.QuantitySection==null||menuItem.QuantitySection.length==0)&&SelectedQuantity(menuItem)==0">
